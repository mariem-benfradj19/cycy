...
/* Home/TeamDetails.html.twig */
class __TwigTemplate_7063712365e426adb69fdb7fdd96507e extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "Home/TeamDetails.html.twig"));
...
<body>
                ...
                <div class=\"col-lg-12\">
                    <div class=\"breadcrumb-main-wrapper\">
                        <div class=\"pagination-wrapper\">
                            ...
                            <a class=\"active\" href=\"Team\">Our Expert Teacher</a>
                        </div>
                        <!-- breadcrumb pagination area -->
                        <h2 class=\"title\">Our Expert Teacher</h2>
    ...
    <!-- course area start -->
    <section class=\"rts-team-details-area rts-section-gap inner\">
        <div class=\"container\">
                    ...
                    <div class=\"col-lg-4 rts-sticky-column-item\">
                        <div class=\"team-wrapper-style-3\">
                            <div class=\"wrapper-inner\">
                                ...
                                <div class=\"content\">
                                    <h4 class=\"title\"><a href=\"#\">Eleanor Alice</a></h4>
                                    <p class=\"desig\">Kids Teacher</p>
                                    <ul class=\"get-in-touch\">
                                        <li class=\"phone\">
                                            <span>Phone : <a href=\"call-to:1215224225\">+1 215 224 225</a></span>
                                        </li>
                                        <li class=\"email\">
                                            <span>Email : <a href=\"mail-to:studykids@info.com\">studykids@info.com</a></span>
                                        </li>
                                    </ul>
                                </div>
                                <ul class=\"social-area\">
                    ...
                    <div class=\"col-lg-8\">
                        <div class=\"team-info-area\">
                            <div class=\"team-about\">
                                <h3 class=\"heading-title\">Personal Info</h3>
                                <p class=\"desig\">Kids Teacher</p>
                                <p class=\"desc\">Hi, there! My name is Eleanor Alice and I enjoy teaching math. And, at “Math You Can Do” we’re always cooking up some good “recipes” for a tasty math experience! I was a public and private school educator for 36 years, and have experience teaching 3rd through 6th grade math. I was a principal for 5 years too, but I must say, it is much more fun and rewarding to teach.</p>
                            </div>
                            <div class=\"team-features\">
                                <ul>
                                    <li>
                                        <h5 class=\"title\">Specialty:</h5>
                                        <p class=\"desc\">Dealing With Kids, My Passion</p>
                                    </li>
                                    <li>
                                        <h5 class=\"title\">Experience:</h5>
                                        <p class=\"desc\">6 Years Experience, at StudyKids School</p>
                                    </li>
                                    <li>
                                        <h5 class=\"title\">Education:</h5>
                                        <p class=\"desc\">Degree, e.g., Bachelor of Arts in English</p>
                                    </li>
                                </ul>
                            </div>
                            <div class=\"team-skills\">
                                <h3 class=\"heading-title\">Personal Info</h3>
                                <div class=\"progress-wrapper-area\">
                                    <!-- single progress -->
                                    <div class=\"single-progress\">
                                        ...
                                        <div class=\"progress\">
                                            <div class=\"progress-bar wow fadeInLeft\" role=\"progressbar\" style=\"width: 90%\" aria-valuenow=\"25\" aria-valuemin=\"0\" aria-valuemax=\"100\"></div>
                                        </div>
                                    </div>
                                    <!-- single progress end -->
                                    <!-- single progress -->
    ...
    {
        return "Home/TeamDetails.html.twig";
    }
...
</html>", "Home/TeamDetails.html.twig", "C:\\Users\\Lenovo IdeaPad 3i\\Downloads\\Novalearn-INTEGRATION_F_FINAL\\templates\\Home\\TeamDetails.html.twig");
    }
}

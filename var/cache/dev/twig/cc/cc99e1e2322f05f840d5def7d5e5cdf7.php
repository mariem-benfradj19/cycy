...
/* Signup/parents.html.twig */
class __TwigTemplate_9ed4cf2a84895bd493b3bcb9b08d9a11 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "Signup/parents.html.twig"));
...
.form-group {
    ...
    width: calc(50% - 15px); /* Chaque champ prend 50% de la largeur de la ligne */
}
...
.form-group label {
    ...
    margin-bottom: 5px;
    text-align: center;
    font-size: 18px; /* Taille de la police du label augmentée */
}
...
/* Pour les écrans plus petits, ajuster la disposition */
@media (max-width: 900px) {
    .form-group {
        width: calc(50% - 15px); /* Toujours 2 champs par ligne */
    }
}

@media (max-width: 600px) {
    .form-group {
        width: 100%; /* Un champ par ligne */
    }
}
/* Classe spécifique pour les boutons radio */
.radio-btn input[type=\"radio\"] {
    display: none; /* Cache le bouton radio natif */
}

/* Créer l'apparence personnalisée du bouton radio */
.radio-btn label {
    display: inline-block;
    position: relative;
    padding-left: 35px; /* Espace pour l'icône du bouton radio */
    font-size: 18px;
    cursor: pointer;
    color: #333;
    line-height: 20px;
...
/* Créer un cercle pour le bouton radio */
.radio-btn label::before {
    ...
    transition: 0.3s ease; /* Transition douce pour les changements */
}

/* Lorsqu'un bouton radio est sélectionné */
.radio-btn input[type=\"radio\"]:checked + label::before {
    background-color: #007bff; /* Fond bleu lorsqu'il est sélectionné */
    border-color: #0056b3; /* Bordure plus foncée */
    box-shadow: 0 0 5px rgba(0, 123, 255, 0.3); /* Légère ombre bleue */
}

/* Ajouter une coche lorsque sélectionné */
.radio-btn input[type=\"radio\"]:checked + label::after {
    content: '✔'; /* Ajouter la coche */
    position: absolute;
    left: 4px;
    top: -2px;
    font-size: 14px;
...
/* Changer la couleur du texte lorsque l'on survole l'élément */
.radio-btn label:hover {
    color: #007bff; /* Changer la couleur du texte du label au survol */
}
...
<body>
                ...
                <div class=\"col-lg-12\">
                    <div class=\"breadcrumb-main-wrapper\">
                        <div class=\"pagination-wrapper\">
                            ...
                            <a class=\"active\" href=\"contact.html\">Sign Up</a>
                        </div>
    ...
    <!-- course area start -->
   <section class=\"rts-contact-area rts-section-gap inner\" style=\"background: linear-gradient(135deg, #f5f7fa, #c3cfe2); padding: 80px 0; position: relative;\">
    <!-- Image décorative -->
    <img src=\"assets/images/decor/contact-decor.png\" alt=\"Décoration\" class=\"decor-image\" style=\"position: absolute; top: 20px; right: 20px; width: 100px; opacity: 0.5;\">

    <div class=\"container\">
        <div class=\"section-title-area text-center\">
            <p class=\"pre-title justify-content-center\">
                <img src=\"assets/images/banner/title-img.svg\" alt=\"\"> S'inscrire
            </p>
            <h2 class=\"section-title\">Inscrivez-vous et suivez l'évolution de vos enfants !</h2>
        </div>
...
<body>
    <div class=\"form-container\" style=\"display: flex; justify-content: center; align-items: center; flex-direction: column; padding: 20px; background-color: #f9f9f9; border-radius: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);\">
        <h3 class=\"heading-title text-center\" style=\"text-align: center; color: #333; font-size: 24px; margin-bottom: 20px;\">S'inscrire</h3>
    ...
    <div class=\"form-group\">";
        // line 355
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 355, $this->source); })()), "id_fils", [], "any", false, false, false, 355), 'row');
        yield "</div>
    <div class=\"form-group\">";
        // line 356
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 356, $this->source); })()), "email", [], "any", false, false, false, 356), 'row');
        yield "</div>
    <div class=\"form-group\">";
        // line 357
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 357, $this->source); })()), "genre", [], "any", false, false, false, 357), 'row', ["attr" => ["class" => "radio-btn"]]);
        yield "</div>
    <div class=\"form-group\">";
        // line 358
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 358, $this->source); })()), "password", [], "any", false, false, false, 358), 'row');
        yield "</div>
     ...
     <div class=\"form-btn text-center\">
          ...
          ";
        // line 366
        yield         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 366, $this->source); })()), 'form_end');
    ...
    <div class=\"rts-footer-area section-bg2\">
        <div class=\"container\">
            <div class=\"footer-top\">
                <form action=\"#\">
                    <h3 class=\"form-title\">Découvrez les histoires inspirantes de nos anciens élèves !</h3>
                    <div class=\"form-inner\">
    ...
    {
        return "Signup/parents.html.twig";
    }
    ...
    {
        return array (  847 => 11,  837 => 10,  820 => 7,  436 => 366,  425 => 358,  421 => 357,  417 => 356,  413 => 355,  409 => 354,  405 => 353,  401 => 352,  397 => 351,  393 => 350,  387 => 347,  63 => 25,  61 => 10,  55 => 7,  47 => 1,);
    }
...
<body>
    ...
    <div class=\"form-group\">{{ form_row(form.id_fils) }}</div>
...
</html>", "Signup/parents.html.twig", "C:\\Users\\Lenovo IdeaPad 3i\\Downloads\\Novalearn-INTEGRATION_F_FINAL\\templates\\Signup\\parents.html.twig");
    }
}
